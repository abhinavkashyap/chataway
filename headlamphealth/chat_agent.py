...
class AnxietyChain:
    def __init__(
        ...
        self.system_prompt = (
            "You are an assistant for helping the user with possible anxiety. "
            "Use the following pieces of retrieved context as past journal notes "
            "that the user may have written. First reason the reason for stress and then provide an empathetic response"
            "\n\n"
            "{context}"
        )
